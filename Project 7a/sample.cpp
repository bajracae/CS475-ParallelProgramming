...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Aeijan Bajracharya" };
...
float megaParticlesPerSecond = 0.0;
...
Animate( )
{
	...
	if( ShowPerformance )
	{
		...
		char str[128];
		megaParticlesPerSecond = (float)NUM_PARTICLES / ElapsedTime / 1000000.;
		if (megaParticlesPerSecond > maxPerformance) {
			maxPerformance = megaParticlesPerSecond;
		}
...
Display( )
{
	...
	{
		char str[128];
		//float megaParticlesPerSecond = (float)NUM_PARTICLES / ElapsedTime / 1000000.;
		if (megaParticlesPerSecond > maxPerformance) {
			maxPerformance = megaParticlesPerSecond;
		}
		sprintf( str, "%6.1f MegaParticles/Sec, %6.1f Max MegaParticles/Sec", megaParticlesPerSecond, maxPerformance);
		//printf("%6.1f\n", maxPerformance);
...
InitLists( )
{
	...
	// ****************************************
		...
		glColor3f( 1.0f, 1.0f, 0. );	// 0. <= r,g,b <= 1.
		glPushMatrix( );
	...
	// do this for yourself...
		glColor3f(1.0f, 0.0f, 0.25);	// 0. <= r,g,b <= 1.
		glPushMatrix();
			glTranslatef(-2000.f, -800.f, 0.f); // sphere center
			glutWireSphere(1000.f, 100, 100); // sphere radius, slices, stacks
		glPopMatrix();

		// Sphere 3
		glColor3f(0.0f, 0.0f, 1);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(2000.f, -800.f, 0.f); // sphere center
		glutWireSphere(1000.f, 100, 100); // sphere radius, slices, stacks
		glPopMatrix();
		...
		// Sphere 4
		glColor3f(0.0f, 1.0f, 1);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(0.f, -800.f, -2000.f); // sphere center
		glutWireSphere(1000.f, 100, 100); // sphere radius, slices, stacks
		glPopMatrix();

		// Sphere 5
		glColor3f(1.0f, 1.0, 1.0);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(0.f, -800, 2000.f); // sphere center
		glutWireSphere(1000.f, 100, 100); // sphere radius, slices, stacks
		glPopMatrix();

		// Sphere 6
		glColor3f(0.65f, 0.45f, 3);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(0.f, -8500, 0.f); // sphere center
		glutWireSphere(6000.f, 100, 100); // sphere radius, slices, stacks
		glPopMatrix();
